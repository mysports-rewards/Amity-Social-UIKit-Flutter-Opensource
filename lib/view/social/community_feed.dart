      ...
      return StreamBuilder<AmityCommunity>(
          ...
          builder: (context, snapshot) {
            ...
            return Scaffold(
                ...
                body: Stack(
                  children: [
                    IntrinsicDimension(listener: (context, width, height, startOffset) {
                      Provider.of<CompoentSizeVM>(context, listen: false).setCommunityDetailSectionSize(height);
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: widget.community.avatarImage != null
                          ...
                          : const DecorationImage(
                              image: AssetImage("assets/images/IMG_5637.JPG", package: 'amity_uikit_beta_service'),
                              fit: BoxFit.cover),
                    ),
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        color: Colors.black.withOpacity(0.4), // Applying a 40% dark filter to the entire container
                      ),
                    ),
                  ),
                ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              (widget.community.description != null) ? communityDescription(widget.community) : const SizedBox(),
              SizedBox(
